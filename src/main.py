...
def train(model, loader):
    ...
    print(len(loader.trainSamples))
    print(loader.trainSamples[0])
...
def load_different_image():
    ...
    for i in range(1, Model.batchSize):
       imgs.append(preprocessor(cv2.imread("/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/data/check_image/a ({}).png".format(i), cv2.IMREAD_GRAYSCALE), Model.imgSize, enhance=False))
    return imgs
