...
class Model:
    ...
    def setupTF(self):
        ...
        modelDir = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/model/'
    ...
    def save(self):
        """ Save model to file """
        self.snapID += 1
        self.saver.save(self.sess, '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/model/snapshot',
