...
class FilePaths:
    ...
    fnCharList = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/model/charList.txt'
    fnWordCharList = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/model/wordCharList.txt'
    fnCorpus = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/data/corpus.txt'
    fnAccuracy = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/model/accuracy.txt'
    fnTrain = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/data/'
    fnInfer = '/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/data/testImage1.png'  ## path to recognize the single image
...
class DataLoader:
    ...
    def __init__(self, filePath, batchSize, imgSize, maxTextLen, load_aug=True):
        ...
        f = open("/content/drive/My Drive/Handwritten-Line-Text-Recognition-using-Deep-Learning-with-Tensorflow-master/data/" + 'lines.txt')
        chars = set()
        bad_samples = []
